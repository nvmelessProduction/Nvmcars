...
export const en: Translations = {
  ...
  auth: {
    ...
    loginSubtitle: "Sign in to your Nvmcars account.",
    demoModeTitle: "Demo mode (offline)",
    demoModeBody: "Backend not configured. Pick a demo account:",
    demoCustomer: "Demo Customer",
    demoPro: "Demo Pro",
    checkEmailTitle: "Confirm your email",
    checkEmailBody: "We sent an email to {email}. Tap the link to activate your account.",
  },
  home: {
    hello: "Hi",
  ...
  car: {
    ...
    reminderKindRevision: "Inspection",
    reminderKindService: "Service",
    reminderKindInsurance: "Insurance",
    reminderKindTax: "Road tax",
    reminderHeader: "Reminders",
    carSectionLabel: "Car",
    serviceLogSectionLabel: "Service history",
    reminderDueDate: "Due date",
    reminderDaysLeft: "in {n} days",
    reminderDueToday: "today",
    reminderOverdue: "{n} days overdue",
  },
  bookings: {
  ...
  chat: {
    ...
    startConversationHint: "Send a message to get in touch.",
  },
  quote: {
    quote: "Quote",
    ...
    expiredBody: "This quote is no longer valid. Ask the workshop to send an updated one in chat.",
    reservedInShopTitle: "Pay at the workshop",
    reservedInShopBody: "You chose to pay directly at the workshop. No in-app payment needed.",
  ...
  payment: {
    ...
    alreadyPaidBody: "This quote has already been settled. You can find the details in your bookings.",
  ...
  reviews: {
    ...
    commentTooShort: "Please write a few words about your experience.",
    thanksTitle: "Thanks!",
    thanksBody: "Your review has been published.",
    rating1: "Awful",
    rating2: "Poor",
    rating3: "Average",
    rating4: "Very good",
